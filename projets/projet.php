...
<html lang="fr">
  ...
  <body>
    <div class="container">
      ...
      <?php echo '<p><span class="importantText">Résultat : </span>' . $projetResultat . '</p>' ?>
      <?php echo '<p><span class="importantText">Technologies utilisées : </span>' . $projetTechnos . '</p>' ?>
      <h2>Galerie</h2>
      ...
      <div class="flexboxBtnTelechargement">
          <?php echo '<a href="projetsZips/' . $projetTelechargement . '" download="' . $projetTelechargement .'" class="btn-success btn-lg btn">Télécharger</a>'?>
